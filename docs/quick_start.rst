...
.. code:: bash
   ...
   pip install -U http://epopt.s3.amazonaws.com/epopt-0.3.0-cp27-none-macosx_10_11_x86_64.whl
..
...
.. code:: bash
   ...
   pip install -U http://epopt.s3.amazonaws.com/epopt-0.3.0-cp27-none-linux_x86_64.whl
..
